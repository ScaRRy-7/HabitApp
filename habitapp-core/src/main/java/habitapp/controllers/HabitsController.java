 ...
 * Предоставляет API для создания, получения, редактирования и удаления привычек.
 */
...
public class HabitsController {
    ...
    /**
     * Создает новую привычку для авторизованного пользователя.
     *
     * @param authHeader Заголовок авторизации.
     * @param habitDTO  Объект с данными новой привычки.
    ...
    public ResponseEntity<String> createHabit(
        ...
        if (habitDTO == null) {
                    return ResponseEntity.badRequest().contentType(MediaType.APPLICATION_JSON)
                            .body("{\"message\": \"Incorrect json (null)\"}");
        }
        try {
    ...
    /**
     * Получает все привычки для авторизованного пользователя.
     *
     * @param authHeader Заголовок авторизации.
     * @return Список привычек пользователя в формате JSON.
    ...
    /**
     * Удаляет указанную привычку для авторизованного пользователя.
     *
     * @param authHeader Заголовок авторизации.
     * @param habitDTO  Объект с данными привычки для удаления.
     * @return Список оставшихся привычек в формате JSON.
     * @throws IOException В случае ошибки при обработке JSON.
     */
    @Operation(
    ...
    /**
     * Изменяет существующую привычку для авторизованного пользователя.
     *
     * @param authHeader Заголовок авторизации.
     * @param habitDTO1 Объект с оригинальной привычкой.
     * @param habitDTO2 Объект с обновленной привычкой.
     * @return Ответ с сообщением о результате операции.
     * @throws JsonProcessingException В случае ошибки при обработке JSON.
     */
    @Operation(
